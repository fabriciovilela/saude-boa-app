  ...
  return (
    <>
      ...
      <Link href={props.changeRecipe ? "/panel" : "/recipe/" + props.recipe._id} onClick={changeRecipe}>
        ...
        <img src={props.recipe?._id ? (props.recipe?.image ? props.recipe.image : "https://storage.googleapis.com/recipes-photos/" + props.recipe._id + ".jpeg") : "#"} alt="" className="recipeItemImage" />
